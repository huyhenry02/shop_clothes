...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{ route('admin.invoice.postInvoice') }}" enctype="multipart/form-data" id="invoice-form">
                @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered" id="product-table">
                                    ...
                                    <tr class="product-row">
                                        <td><input type="text" name="invoice_details[0][code]" class="form-control product-code"></td>
                                        <td><img src="/customer/images/products/default.jpg" class="product-image" style="width: 50px;" alt=""></td>
                                        <td><input type="text" class="form-control product-name" disabled></td>
                                        <td><select name="invoice_details[0][size]" class="form-control product-size"></select></td>
                                        <td><input type="number" name="invoice_details[0][quantity]" class="form-control quantity" min="1" value="1"></td>
                                        <td><input type="text" class="form-control unit-price" disabled></td>
                                        <td><input type="number" name="invoice_details[0][total_price]" class="form-control total_price" readonly></td>
                                        <td>
